...
par(mfrow=c(2,2))
plot(sub_df$DateTime, sub_df$Global_active_power, type='n', xlab='', ylab='Global Active Power')
lines(sub_df$DateTime, sub_df$Global_active_power)

plot(sub_df$DateTime, sub_df$Voltage, type='n', xlab='datetime', ylab='Voltage')
lines(sub_df$DateTime, sub_df$Voltage)
...
plot(sub_df$DateTime, sub_df$Global_reactive_power, type='n', xlab='datetime', ylab='Global_reactive_power')
lines(sub_df$DateTime, sub_df$Global_reactive_power)
dev.off()